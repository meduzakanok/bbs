		...
		<div class="wrapper d-flex align-items-stretch">
			...
			<div id="content" class="p-4 p-md-5">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="nav navbar-nav ml-auto">
								...
								<li class="nav-item active"><a class="nav-link" href="admin_module.php">[ SAP Modules ]</a></li>
							</ul>
					</div>
				</div>
				</nav>
				...
				<tr>
					...
					<td style="text-align:center"><button type="button" class="btn btn-primary" title="Add Module" id="btn_add" name="btn_add" formaction="addedt_module.php?id=0"><i class="fa fa-plus-square-o"></i> Add Module</button></td>
				</tr>
				</table>
				<table id="tabRecord" style="width:100%;" border="0">
				<tr class="header">
					<th style="width:80%;">Modules</th>
					<th>Actions</th>
				</tr>
				<tr>
					<td>SAP Financial Accounting (FI)</td>
					<td>
						<button type="button" class="btn btn-lg btn-success" title="Edit Language" id="btn_edt" name="btn_edt" formaction="addedt_module.php?id=1"><i class="fa fa-edit"></i></button>
						<button type="button" class="btn btn-lg btn-danger" title="Delete Language" id="btn_del" name="btn_del" formaction="del.php?frm=module&id=1"><i class="fa fa-trash-o"></i></button>
					</td>
				</tr>
				<tr>
					<td>SAP Controlling (CO)</td>
					<td>
						<button type="button" class="btn btn-lg btn-success" title="Edit Language" id="btn_edt" name="btn_edt" formaction="addedt_module.php?id=2"><i class="fa fa-edit"></i></button>
						<button type="button" class="btn btn-lg btn-danger" title="Delete Language" id="btn_del" name="btn_del" formaction="del.php?frm=module&id=2"><i class="fa fa-trash-o"></i></button>
					</td>
				</tr>
				<tr>
					<td>Finance and Controlling (FICO)</td>
					<td>
						<button type="button" class="btn btn-lg btn-success" title="Edit Language" id="btn_edt" name="btn_edt" formaction="addedt_module.php?id=3"><i class="fa fa-edit"></i></button>
						<button type="button" class="btn btn-lg btn-danger" title="Delete Language" id="btn_del" name="btn_del" formaction="del.php?frm=module&id=3"><i class="fa fa-trash-o"></i></button>
					</td>
				</tr>
				</table>
			</div>
