		...
		<div class="wrapper d-flex align-items-stretch">
			...
			<div id="content" class="p-4 p-md-5">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="nav navbar-nav ml-auto">
								...
								<li class="nav-item active"><a class="nav-link" href="admin_module.php?l=<?php echo $l?>"><font color="#0891f8">[ SAP Modules ]</font></a></li>
				...
				<tr>
					...
					<td style="text-align:center"><button type="button" class="btn btn-primary" title="Add Module" id="btn_add" name="btn_add" formaction="addedt_module.php?l=<?php echo $l?>&id=0"><i class="fa fa-plus-square-o"></i> Add Module</button></td>
				</tr>
				</table>
				<table id="tabRecord" style="width:100%;" border="0">
				<tr class="header">
					<th style="width:70%;">Modules Description</th>
					<th style="width:20%;">Modules Value</th>
					<th>Actions</th>
				</tr>
				<?php
					$sql_module = "SELECT * FROM sap_modules ";
					$sql_module .= " order by SAP_module ";
					$stmt_module = $con->query($sql_module);
					$rows_res = $stmt_module->rowCount();
					if ($rows_res >0){
						while ($result_module = $stmt_module->fetch()) {
				?>
				<tr>
					<td><?php echo $result_module['SAP_module']?></td>
					<td><?php echo $result_module['SAP_moduleVal']?></td>
					<td>
						<button type="button" class="btn btn-lg btn-success" title="Edit Language" id="btn_edt" name="btn_edt" formaction="addedt_module.php?l=<?php echo $l?>&id=<?php echo $result_module['SAP_ID']?>"><i class="fa fa-edit"></i></button>
						<button type="button" class="btn btn-lg btn-danger" title="Delete Language" id="btn_del" name="btn_del" formaction="del.php?l=<?php echo $l?>&frm=module&id=<?php echo $result_module['SAP_ID']?>"><i class="fa fa-trash-o"></i></button>
					</td>
				</tr>
				<?php }
					}
