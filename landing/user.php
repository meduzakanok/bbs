		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar" class="active">
				...
				<ul class="list-unstyled components mb-5">
					...
					<li><a href="admin.php"><span class="fa fa-cog"></span> ADMIN</a></li>
					<li class="active"><a href="user.php"><span class="fa fa-user"></span> USER</a></li>
			...
			<div id="content" class="p-4 p-md-5">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="nav navbar-nav ml-auto">
								<li class="nav-item active"><a class="nav-link" href="search.html">User List</a></li>
							</ul>
					</div>
				</div>
				</nav>
				...
				<tr>
					...
					<td style="text-align:center"><button type="button" class="btn btn-primary" title="Add User" id="btn_add" name="btn_add" formaction="addedt_user.php?id=0"><i class="fa fa-plus-square-o"></i> Add User</button></td>
				</tr>
				</table>
				...
				<tr>
					...
					<td>Germany</td>
					<td>
						<button type="button" class="btn btn-lg btn-success" title="Edit User" id="btn_edt" name="btn_edt" formaction="addedt_user.php?id=1"><i class="fa fa-edit"></i></button>
						<button type="button" class="btn btn-lg btn-danger" title="Delete User" id="btn_del" name="btn_del" formaction="del.php?frm=user&id=1"><i class="fa fa-trash-o"></i></button>
					</td>
				</tr>
				<tr>
					...
					<td>Germany</td>
					<td>
						<button type="button" class="btn btn-lg btn-success" title="Edit User" id="btn_edt" name="btn_edt" formaction="addedt_user.php?id=2"><i class="fa fa-edit"></i></button>
						<button type="button" class="btn btn-lg btn-danger" title="Delete User" id="btn_del" name="btn_del" formaction="del.php?frm=user&id=2"><i class="fa fa-trash-o"></i></button>
					</td>
				</tr>
				<tr>
					...
					<td>Germany</td>
					<td>
						<button type="button" class="btn btn-lg btn-success" title="Edit User" id="btn_edt" name="btn_edt" formaction="addedt_user.php?id=3"><i class="fa fa-edit"></i></button>
						<button type="button" class="btn btn-lg btn-danger" title="Delete User" id="btn_del" name="btn_del" formaction="del.php?frm=user&id=3"><i class="fa fa-trash-o"></i></button>
					</td>
				</tr>
				<tr>
					<td>Sweeden</td>
					...
					<td>Germany</td>
					<td>
						<button type="button" class="btn btn-lg btn-success" title="Edit User" id="btn_edt" name="btn_edt" formaction="addedt_user.php?id=4"><i class="fa fa-edit"></i></button>
						<button type="button" class="btn btn-lg btn-danger" title="Delete User" id="btn_del" name="btn_del" formaction="del.php?frm=user&id=4"><i class="fa fa-trash-o"></i></button>
					</td>
				</tr>
				</table>
			</div>
