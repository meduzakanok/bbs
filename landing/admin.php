		...
		<div class="wrapper d-flex align-items-stretch">
			...
			<div id="content" class="p-4 p-md-5">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="nav navbar-nav ml-auto">
								<li class="nav-item active"><a class="nav-link" href="admin.php?l=<?php echo $l?>"><font color="#0891f8">[ Company ]</font></a></li>
				...
				<tr>
					...
					<td style="text-align:center"><button type="button" class="btn btn-primary" title="Add Company" id="btn_add" name="btn_add" formaction="addedt_company.php?l=<?php echo $l?>&id=0"><i class="fa fa-plus-square-o"></i> Add Company</button></td>
				</tr>
				</table>
				...
				<?php
					$sql_comp = "SELECT * FROM client_company ";
					$sql_comp .= " order by client_company";
					$stmt_comp = $con->query($sql_comp);
					$rows_res = $stmt_comp->rowCount();
					if ($rows_res >0){
						while ($result_comp = $stmt_comp->fetch()) {
				?>
				<tr>
					<td><?php echo $result_comp['client_company']?></td>
					<td><?php echo $result_comp['client_department']?></td>
					<td><?php echo $result_comp['client_contact']?></td>
					<td>
						<button type="button" class="btn btn-lg btn-success" title="Edit Company" id="btn_edt" name="btn_edt" formaction="addedt_company.php?l=<?php echo $l?>&id=<?php echo $result_comp['client_ID']?>"><i class="fa fa-edit"></i></button>
						<button type="button" class="btn btn-lg btn-danger" title="Delete Company" id="btn_del" name="btn_del" formaction="del.php?l=<?php echo $l?>&frm=company&id=<?php echo $result_comp['client_ID']?>"><i class="fa fa-trash-o"></i></button>
					</td>
				</tr>
				<?php }
					}
